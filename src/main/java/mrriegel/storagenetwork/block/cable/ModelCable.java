...
public class ModelCable extends ModelBase {
  ...
  public ModelCable() {
    ...
    this.upC.addBox(-3.0F, -3.0F, 7.01F, 6, 6, 1, 0.0F);
    ...
    this.downC.addBox(-3.0F, -3.0F, 7.01F, 6, 6, 1, 0.0F);
    ...
    this.southC.addBox(-3.0F, -3.0F, 7.01F, 6, 6, 1, 0.0F);
    this.westC = new ModelRenderer(this, 16, 0);
    this.westC.setRotationPoint(0.0F, 0.0F, 0.0F);
    this.westC.addBox(-3.0F, -3.0F, 7.01F, 6, 6, 1, 0.0F);
    ...
    this.northC.addBox(-3.0F, -3.0F, 7.01F, 6, 6, 1, 0.0F);
    ...
    this.eastC.addBox(-3.0F, -3.0F, 7.01F, 6, 6, 1, 0.0F);
